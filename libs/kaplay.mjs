...
var xi = 1103515245
    ...
    gen() {
        return this.seed = (xi * this.seed + Ui) % wr,
        this.seed / wr
    }
    genNumber(e, o) {
...
function Ei(n, e) {
    ...
    if (o === 0)
        return null;
    let c = ((e.p2.x - e.p1.x) * (n.p1.y - e.p1.y) - (e.p2.y - e.p1.y) * (n.p1.x - e.p1.x)) / o
        , g = ((n.p2.x - n.p1.x) * (n.p1.y - e.p1.y) - (n.p2.y - n.p1.y) * (n.p1.x - e.p1.x)) / o;
...
var Yt = class {
        ...
        remove() {
            ...
            let e = this._items[0]
                , o = this._items.pop();
            return this._items.length !== 0 && (this._items[0] = o,
                this.moveDown(0)),
                e
        }
        clear() {
        ...
        moveDown(e) {
            for (; e < Math.floor(this._items.length / 2); ) {
                let o = 2 * e + 1;
                if (o < this._items.length - 1 && !this._compareFn(this._items[o], this._items[o + 1]) && ++o,
...
var at = class {
    ...
    , $n = class {
    static{i(this, "GamepadState")
    }buttonState = new at;
    stickState = new Map
}
    , zn = class {
    static{i(this, "FPSCounter")
    }dts = [];
    timer = 0;
    fps = 0;
    tick(e) {
        ...
        this.timer >= 1 && (this.timer = 0,
            this.fps = Math.round(1 / (this.dts.reduce((o,c)=>o + c) / this.dts.length)),
            this.dts = [])
    }
}
    , Ir = i(n=>{
        ...
        i(un, "onResize");
        let cn = Ee(l=>e.events.on("keyDown", l), (l,x)=>e.events.on("keyDown", R=>R === l && x(l)))
            , hn = Ee(l=>e.events.on("keyPress", l), (l,x)=>e.events.on("keyPress", R=>R === l && x(l)))
            , ln = Ee(l=>e.events.on("keyPressRepeat", l), (l,x)=>e.events.on("keyPressRepeat", R=>R === l && x(l)))
            , dn = Ee(l=>e.events.on("keyRelease", l), (l,x)=>e.events.on("keyRelease", R=>R === l && x(l)))
        ...
        ;
        let yn = new Set([" ", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Tab"])
            , qe = {
            ArrowLeft: "left",
            ArrowRight: "right",
            ArrowUp: "up",
...
var Re = class n {
        ...
        constructor(e, o, c, g={}) {
            ...
            this.bind(),
            o && c && m.texImage2D(m.TEXTURE_2D, 0, m.RGBA, o, c, 0, m.RGBA, m.UNSIGNED_BYTE, null),
    ...
    , rt = class {
        ...
        constructor(e, o, c, g={}) {
            ...
            e.onDestroy(()=>this.free()),
                ...
                m.framebufferTexture2D(m.FRAMEBUFFER, m.COLOR_ATTACHMENT0, m.TEXTURE_2D, this.tex.glTex, 0),
                m.framebufferRenderbuffer(m.FRAMEBUFFER, m.DEPTH_STENCIL_ATTACHMENT, m.RENDERBUFFER, this.glRenderbuffer),
                this.unbind()
        }
        get width() {
...
var ve = class n {
    ...
    , je = class {
        static{i(this, "AssetBucket")
        }assets = new Map;
        lastUID = 0;
        add(e, o) {
            let c = e ?? this.lastUID++ + ""
                , g = new ve(o);
            return this.assets.set(c, g),
                g
        }
        addLoaded(e, o) {
            let c = e ?? this.lastUID++ + ""
...
var At = class {
        ...
        add(e) {
            ...
            e.height > this.curHeight && (this.curHeight = e.height),
                ...
                [o, new oe(c.x / this.canvas.width,c.y / this.canvas.height,e.width / this.canvas.width,e.height / this.canvas.height)]
        }
        free() {
...
var zo = i((n={})=>{
        ...
        g ? (o.width = n.width * c,
            o.height = n.height * c) : (o.width = o.parentElement.offsetWidth,
        ...
        if (g) {
            ...
            m.push("width: 100%"),
                m.push("height: 100%");
        n.crisp && (m.push("image-rendering: pixelated"),
                ...
                Ae(typeof r == "string" ? new Promise((s,u)=>{
                        ...
                        for (let a in r) {
                            let h = r[a]
                                ...
                                , b = Xr * f.w
                                , p = Jr * f.h
                                , d = h.frames ? h.frames.map(A=>new oe(f.x + (h.x + A.x) / b * f.w,f.y + (h.y + A.y) / p * f.h,A.w / b * f.w,A.h / p * f.h)) : Tt(h.sliceX || 1, h.sliceY || 1, f.x + h.x / b * f.w, f.y + h.y / p * f.h, h.width / b * f.w, h.height / p * f.h)
        ...
        function un(t, r, s) {
            ...
            return k.sprites.add(t, u.then(a=>{
                    let h = a.meta.size
                        , f = a.frames.map(p=>new oe(p.frame.x / h.w,p.frame.y / h.h,p.frame.w / h.w,p.frame.h / h.h))
                        , b = {};
                    for (let p of a.meta.frameTags)
                        p.from === p.to ? b[p.name] = p.from : b[p.name] = {
                            from: p.from,
                            to: p.to,
                            speed: 10,
                            loop: !0,
        ...
        function Be(t) {
            ...
            let r = t.width
                , s = t.height
                , a = ut(t.anchor || tn).scale(new v(r,s).scale(-.5))
        ...
        function We(t) {
            ...
            if (t.tiled) {
                let h = Math.ceil((t.width || s) / s)
                    ...
                    , p = ut(t.anchor || tn).add(new v(1,1)).scale(.5).scale(h * s, f * u);
                for (let d = 0; d < h; d++)
                    for (let w = 0; w < f; w++)
                        Be(Object.assign({}, t, {
        ...
        function ge(t) {
            ...
            let r = t.width
                , s = t.height
                , a = ut(t.anchor || tn).add(1, 1).scale(new v(r,s).scale(-.5))
            ...
            if (r instanceof Se || typeof r == "string") {
                ...
                for (let fe of a)
                    if (!V.font.map[fe]) {
                        ...
                        if (V.cursor.x + B > Yr && (V.cursor.x = 0,
                            V.cursor.y += F,
                        V.cursor.y > Wr))
...
`)
            ...
            let r = new Map
                ...
                use(d) {
                    ...
                    d.destroy && w.push(d.destroy.bind(this)),
                        this.exists() ? (A(),
                        d.add && (h = i(D=>w.push(D), "onCurCompCleanup"),
                            d.add.call(this),
                ...
                get(d, w={}) {
                    ...
                    if (A = A.filter(D=>d ? D.is(d) : !0),
                        w.liveUpdate) {
                        let D = i(_=>w.recursive ? this.isAncestorOf(_) : _.parent === this, "isChild")
                            , N = [];
                        N.push(En(_=>{
                                D(_) && _.is(d) && A.push(_)
                            }
        ...
        let as = Ee(t=>{
            ...
            , (t,r)=>ze("draw", t, r))
            , En = Ee(t=>C.events.on("add", t), (t,r)=>ze("add", t, r))
            , ir = Ee(t=>C.events.on("destroy", t), (t,r)=>ze("destroy", t, r));
        function cs(t, r, s) {
        ...
        function Cn(t, r={}) {
            ...
            let f = i((b,p,d,w)=>{
                    let A = T(1, 1);
                    return d && w ? (A.x = d / (b.width * p.w),
                        A.y = w / (b.height * p.h)) : d ? (A.x = d / (b.width * p.w),
                        A.y = A.x) : w && (A.y = w / (b.height * p.h),
                        A.x = A.y),
                        A
                }
                , "calcTexScale");
                ...
                draw() {
                    ...
                    if (s.slice9) {
                        let {left: p, right: d, top: w, bottom: A} = s.slice9
                            ...
                            , V = A / N
                            , fe = 1 - H - V
                            , U = [ce(0, 0, O, H), ce(O, 0, Z, H), ce(O + Z, 0, ie, H), ce(0, H, O, fe), ce(O, H, Z, fe), ce(O + Z, H, ie, fe), ce(0, H + fe, O, V), ce(O, H + fe, Z, V), ce(O + Z, H + fe, ie, V), ce(0, 0, p, w), ce(p, 0, _, w), ce(p + _, 0, d, w), ce(0, w, p, M), ce(p, w, _, M), ce(p + _, w, d, M), ce(0, w + M, p, A), ce(p, w + M, _, A), ce(p + _, w + M, d, A)];
                        for (let G = 0; G < 9; G++) {
                            let B = U[G]
                                , F = U[G + 9];
        ...
        function js(t, r={}) {
            ...
            return {
                ...
                async add() {
                    await hr(t),
                    s > 0 && this.opacity && await Rn(this.opacity, 0, s, u=>this.opacity = u, Ct.linear),
                        this.destroy()
                }
            }
        }
        ...
        function cr(t={}) {
            ...
            return {
                ...
                set tilePos(b) {
                    let p = this.getLevel();
                    r = b.clone(),
                        this.pos = T(this.tilePos.x * p.tileWidth(), this.tilePos.y * p.tileHeight()).add(this.tilePosOffset)
                },
                get tilePos() {
                    return r
                },
                ...
                getTilePath(U, G, B={}) {
                    ...
                    for (me.set(F, 0); ee.length !== 0; ) {
                        ...
                        for (let et of Mn) {
                            ...
                            (!me.has(et) || Gn < me.get(et)) && (me.set(et, Gn),
                                ee.insert({
                                    cost: Gn,
                                    node: et
                                }),
        ...
        function ui(t, r={}) {
            ...
            return h.wait(.4 / u, ()=>h.use(lr(u, a))),
...
`),
        ...
        function pr() {
            y.onHide(()=>{
                ...
                y.onResize(()=>{
                        ...
                        t && !n.stretch && !n.letterbox || (o.width = o.offsetWidth * P,
        ...
        if (n.plugins && n.plugins.forEach(ur),
        n.global !== !1)
            for (let t in Ze)
                window[t] = Ze[t];
...
//# sourceMappingURL=kaboom.mjs.world
