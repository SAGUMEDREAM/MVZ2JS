...
;
var Ee = (s,t,c)=>(fi(s, typeof t != "symbol" ? t + "" : t, c),
    c);
var pi = (()=>{
...
var ae = class {
    ...
    static fromHSL(t, c, g) {
        ...
        let E = o((ce,U,X)=>(X < 0 && (X += 1),
        X > 1 && (X -= 1),
            X < 1 / 6 ? ce + (U - ce) * 6 * X : X < 1 / 2 ? U : X < 2 / 3 ? ce + (U - ce) * (2 / 3 - X) * 6 : ce), "hue2rgb")
            , M = g < .5 ? g * (1 + c) : g + c - g * c
            , z = 2 * g - M
            , I = E(z, M, t + 1 / 3)
            , k = E(z, M, t)
...
var J = class {
        ...
        translate(t) {
            return this.m[12] += this.m[0] * t.x + this.m[4] * t.y,
...
var gi = 1103515245
    ...
    , rt = class {
        ...
        gen() {
            return this.seed = (gi * this.seed + wi) % dr,
            this.seed / dr
        }
        genNumber(t, c) {
...
var De = class {
        handlers = {};
        on(t, c) {
            return this.handlers[t] || (this.handlers[t] = new ve),
...
var Ut = class {
        ...
        remove() {
            ...
            let t = this._items[0]
                , c = this._items.pop();
            return this._items.length !== 0 && (this._items[0] = c,
                this.moveDown(0)),
                t
        }
        clear() {
        ...
        moveDown(t) {
            for (; t < Math.floor(this._items.length / 2); ) {
                let c = 2 * t + 1;
                if (c < this._items.length - 1 && !this._compareFn(this._items[c], this._items[c + 1]) && ++c,
...
var Yt = class {
        ...
        tick(t) {
            ...
            this.timer >= 1 && (this.timer = 0,
                this.fps = Math.round(1 / (this.dts.reduce((c,g)=>c + g) / this.dts.length)),
                this.dts = [])
        }
    }
;
...
var Or = o(s=>{
        ...
        function ft() {
            ...
            for (let d of t.gamepads) {
                ...
                for (let V = 0; V < b.buttons.length; V++)
                    b.buttons[V].pressed ? (re.buttonState.down.has(ee.buttons[V]) || (t.mergedGamepadState.buttonState.press(ee.buttons[V]),
                        re.buttonState.press(ee.buttons[V]),
                        t.events.trigger("gamepadButtonPress", ee.buttons[V])),
                        t.events.trigger("gamepadButtonDown", ee.buttons[V])) : re.buttonState.down.has(ee.buttons[V]) && (t.mergedGamepadState.buttonState.release(ee.buttons[V]),
        ...
        de.mousedown = d=>{
            t.events.onOnce("input", ()=>{
                    let b = Ft[d.button];
                    b && (t.mouseState.press(b),
                        t.events.trigger("mousePress", b))
                }
            )
        }
            ,
        ...
        de.keydown = d=>{
            gn.has(d.key) && d.preventDefault(),
                t.events.onOnce("input", ()=>{
                        ...
                        b.length === 1 ? (t.events.trigger("charInput", b),
                            t.charInputted.push(b)) : b === "space" && (t.events.trigger("charInput", " "),
                            t.charInputted.push(" ")),
                            d.repeat ? (t.keyState.pressRepeat(b),
                                t.events.trigger("keyPressRepeat", b)) : (t.keyState.press(b),
            ...
            de.keyup = d=>{
                t.events.onOnce("input", ()=>{
                        let b = Bt[d.key] || d.key.toLowerCase();
                        t.keyState.release(b),
                            t.events.trigger("keyRelease", b)
                    }
                )
            }
            ,
            de.touchstart = d=>{
                d.preventDefault(),
                    t.events.onOnce("input", ()=>{
                            ...
                            s.touchToMouse !== !1 && (t.mousePos = new v(b[0].clientX,b[0].clientY),
...
var at = class {
        ...
        tick(t) {
            return this.finished || this.paused ? !1 : (this.time -= t,
                this.time <= 0 ? (this.action(),
                    this.finished = !0,
                    this.time = 0,
                    !0) : !1)
        }
...
var mo = o((s={})=>{
        ...
        t === document.body && (document.body.style.width = "100%",
        ...
        E ? (c.width = s.width * g,
            c.height = s.height * g) : (c.width = c.parentElement.offsetWidth,
        ...
        E ? (k.push(`width: ${M}px`),
            k.push(`height: ${z}px`)) : (k.push("width: 100%"),
            k.push("height: 100%")),
        s.crisp && (k.push("image-rendering: pixelated"),
        ...
        class K {
            ...
            constructor(n, r, i={}) {
                this.glTex = h.createTexture(),
                    X.push(()=>this.free()),
                    this.bind(),
                n && r && h.texImage2D(h.TEXTURE_2D, 0, h.RGBA, n, r, 0, h.RGBA, h.UNSIGNED_BYTE, null),
                    this.width = n,
                    this.height = r;
                let u = (()=>{
        ...
        class pe {
            ...
            add(n) {
                ...
                this.x + n.width > this.canvas.width && (this.x = 0,
                    this.y += this.curHeight,
                    this.curHeight = 0),
                this.y + n.height > this.canvas.height && (this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
                    this.tex = K.fromImage(this.canvas),
                    this.x = 0,
                    this.y = 0,
                    this.curHeight = 0);
                let r = new v(this.x,this.y);
                return this.x += n.width,
                n.height > this.curHeight && (this.curHeight = n.height),
                    n instanceof ImageData ? this.ctx.putImageData(n, r.x, r.y) : this.ctx.drawImage(n, r.x, r.y),
                    this.tex.update(this.canvas),
                    [this.tex, new Q(r.x / this.canvas.width,r.y / this.canvas.height,n.width / this.canvas.width,n.height / this.canvas.height)]
            }
        }
        o(pe, "TexPacker");
        class Ge {
            ...
            constructor(n, r, i={}) {
                this.tex = new K(n,r,i),
                    ...
                    h.framebufferTexture2D(h.FRAMEBUFFER, h.COLOR_ATTACHMENT0, h.TEXTURE_2D, this.tex.glTex, 0),
                    h.framebufferRenderbuffer(h.FRAMEBUFFER, h.DEPTH_STENCIL_ATTACHMENT, h.RENDERBUFFER, this.glRenderBuffer),
                    this.unbind()
            }
            get width() {
        ...
        let w = (()=>{
                let e = ft(kn, _n)
                    , n = K.fromImage(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]),1,1))
                    , r = s.width && s.height ? new Ge(s.width * I,s.height * I) : new Ge(h.drawingBufferWidth / g,h.drawingBufferHeight / g)
                    , i = null
                    , u = 1;
                s.background && (i = L.fromArray(s.background),
                    u = s.background[3] ?? 1,
                ...
                h.bindBuffer(h.ARRAY_BUFFER, l),
                    ...
                    Kr.reduce((f,p,x)=>(h.vertexAttribPointer(x, p.size, h.FLOAT, !1, Zt * 4, f),
                ...
                let m = K.fromImage(new ImageData(new Uint8ClampedArray([128, 128, 128, 255, 190, 190, 190, 255, 190, 190, 190, 255, 128, 128, 128, 255]),2,2), {
                    wrap: "repeat",
                    filter: "nearest"
                });
                return {
        ...
        class le {
            ...
            static fromImage(n, r={}) {
                let[i,u] = B.packer.add(n)
                    , l = r.frames ? r.frames.map(a=>new Q(u.x + a.x * u.w,u.y + a.y * u.h,a.w * u.w,a.h * u.h)) : Et(r.sliceX || 1, r.sliceY || 1, u.x, u.y, u.w, u.h);
        ...
        class ie {
            ...
            onLoad(n) {
                return this.loaded && this.data ? n(this.data) : this.onLoadEvents.add(n),
                    this
            }
            onError(n) {
                return this.loaded && this.error ? n(this.error) : this.onErrorEvents.add(n),
                    this
            }
            onFinish(n) {
                return this.loaded ? n() : this.onFinishEvents.add(n),
                    this
            }
            then(n) {
        ...
        function sn(e, n, r={}) {
            ...
            return document.fonts.add(i),
                B.fonts.add(e, i.load().catch(u=>{
            ...
            return ct(typeof n == "string" ? new Promise((r,i)=>{
                    ...
                    for (let u in n) {
                        let l = n[u]
                            ...
                            , m = kr * a.w
                            , f = _r * a.h
                            , p = l.frames ? l.frames.map(D=>new Q(a.x + (l.x + D.x) / m * a.w,a.y + (l.y + D.y) / f * a.h,D.w / m * a.w,D.h / f * a.h)) : Et(l.sliceX || 1, l.sliceY || 1, a.x + l.x / m * a.w, a.y + l.y / f * a.h, l.width / m * a.w, l.height / f * a.h)
                            , x = new le(r.tex,p,l.anims);
                        B.sprites.addLoaded(u, x),
                            i[u] = x
                    }
                    return i
                }
        ...
        function an(e, n) {
            return B.sprites.add(e, new Promise(async r=>{
                    ...
                    l.width = i.width,
                        l.height = i.height * i.frames.length;
        ...
        function un(e, n, r) {
            ...
            return B.sprites.add(e, i.then(u=>{
                    let l = u.meta.size
                        , a = u.frames.map(f=>new Q(f.frame.x / l.w,f.frame.y / l.h,f.frame.w / l.w,f.frame.h / l.h))
                        , m = {};
                    for (let f of u.meta.frameTags)
                        f.from === f.to ? m[f.name] = f.from : m[f.name] = {
                            from: f.from,
                            to: f.to,
                            speed: 10,
                            loop: !0,
        ...
        o(Dt, "resolveFont");
        function pn(e) {
            return e !== void 0 && (he.masterNode.gain.value = e),
        ...
        function dt(e, n={}) {
            ...
            return {
                ...
                seek(O) {
                    u.buffer?.duration && (O > u.buffer.duration || (i ? (u = $(u),
                        f = p - O) : (u.stop(),
                        u = $(u),
                        f = r.currentTime - O,
                        u.start(0, O),
                ...
                h.deleteShader(l),
                {
                    ...
                    send(m) {
                        for (let f in m) {
                            ...
                            typeof p == "number" ? h.uniform1f(x, p) : p instanceof J ? h.uniformMatrix4fv(x, !1, new Float32Array(p.m)) : p instanceof L ? h.uniform3f(x, p.r, p.g, p.b) : p instanceof v && h.uniform2f(x, p.x, p.y)
                        }
                    }
                }
        }
        ...
        o(Be, "drawRaw");
        function fe() {
            !w.curTex || !w.curShader || w.vqueue.length === 0 || w.iqueue.length === 0 || (h.bindBuffer(h.ARRAY_BUFFER, w.vbuf),
        ...
        function Oe(e) {
            ...
            re(),
                ...
                Be([{
                    ...
                    color: a,
                    opacity: m
                }], [0, 1, 3, 1, 2, 3], e.fixed, e.tex, e.shader, e.uniform),
                V()
        }
        o(Oe, "drawUVQuad");
        function Ie(e) {
            ...
            if (e.tiled) {
                ...
                e.width && e.height ? (u.x = e.width / r,
                    u.y = e.height / i) : e.width ? (u.x = e.width / r,
                    u.y = u.x) : e.height && (u.y = e.height / i,
                    u.x = u.y),
                    Oe(Object.assign({}, e, {
                        scale: u.scale(e.scale || new v(1)),
                        tex: e.tex,
        ...
        function mt(e, n, r, i, u, l=1) {
            ...
            return a.push(e.add(n * Math.cos(u), r * Math.sin(u))),
                a
        }
        o(mt, "getArcPts");
        function Ce(e) {
            ...
            if (n instanceof _e || typeof n == "string") {
                ...
                for (let Ue of u)
                    if (!F.font.map[Ue]) {
                        ...
                        if (F.cursor.x + P > jr && (F.cursor.x = 0,
                            F.cursor.y += G,
                        F.cursor.y > Nr))
...
`)
                    ...
                    if (H) {
                        ...
                        O != null && ($ -= j.length - O,
                            ...
                            j.push({
                                ...
                                width: H.w,
                                height: H.h,
                                quad: new Q(H.x / n.tex.width,H.y / n.tex.height,H.w / n.tex.width,H.h / n.tex.height),
                                ch: _,
                                pos: new v(p,D),
                                opacity: e.opacity ?? 1,
                                color: e.color ?? L.WHITE,
            ...
            for (let _ of q) {
                ...
                for (let F of _.chars) {
                    let Ue = n.map[F.ch]
                        , y = te.length;
                    if (F.pos = F.pos.add(H, 0).add(Ue.w * a.x * .5, Ue.h * a.y * .5),
                        e.transform) {
        ...
        function ze(e) {
            re(),
                b(e.opt.pos),
                ee(e.opt.angle),
                b(ut(e.opt.anchor ?? "topleft").add(1, 1).scale(e.width, e.height).scale(-.5)),
                e.chars.forEach(n=>{
                        Oe({
                            tex: n.tex,
                            width: n.width,
        ...
        let se = {
            ...
            log: e=>{
                ...
                T.logs.unshift(`${`[time]${U.time().toFixed(2)}[/time] `}[${r}]${e?.toString ? e.toString() : e}[/${r}]`),
            ...
            set paused(e) {
                U.paused = e,
                    e ? he.ctx.suspend() : he.ctx.resume()
            }
        };
        function Te() {
            return U.dt()
        ...
        o(Te, "dt");
        function ts(...e) {
            return e.length > 0 && (T.cam.pos = S(...e)),
                T.cam.pos ? T.cam.pos.clone() : _t()
        }
        o(ts, "camPos");
        function ns(...e) {
            return e.length > 0 && (T.cam.scale = S(...e)),
                T.cam.scale.clone()
        }
        o(ns, "camScale");
        function rs(e) {
            return e !== void 0 && (T.cam.angle = e),
                T.cam.angle
        }
        o(rs, "camRot");
        function ss(e=12) {
        ...
        function Vt(e) {
            let n = new J;
            return e.pos && n.translate(e.pos),
        ...
        function Qn(e) {
            let n = new Map
                ...
                readd(a) {
                    ...
                    return m !== -1 && (this.children.splice(m, 1),
                        this.children.push(a)),
                        a
                },
                remove(a) {
                    let m = this.children.indexOf(a);
                    m !== -1 && (a.trigger("destroy"),
                ...
                update() {
                    this.paused || (this.children.sort((a,m)=>(a.z ?? 0) - (m.z ?? 0)).forEach(a=>a.update()),
                        this.trigger("update"))
                },
                draw() {
                    this.hidden || (re(),
                        ...
                        ee(this.angle),
                        this.trigger("draw"),
                        this.children.sort((a,m)=>(a.z ?? 0) - (m.z ?? 0)).forEach(a=>a.draw()),
                        V())
                },
                drawInspect() {
                    this.hidden || (re(),
                        ...
                        C(this.scale),
                        ee(this.angle),
                        this.children.sort((a,m)=>(a.z ?? 0) - (m.z ?? 0)).forEach(a=>a.drawInspect()),
                ...
                use(a) {
                    ...
                    for (let p in a) {
                        ...
                        if (typeof x.value == "function" && (a[p] = a[p].bind(this)),
                        x.set && Object.defineProperty(a, p, {
                            set: x.set.bind(this)
                        }),
                    ...
                    a.destroy && m.push(a.destroy.bind(this)),
                        this.exists() ? (f(),
                        a.add && (u = o(p=>m.push(p), "onCurCompCleanup"),
                            a.add.call(this),
                            u = null)) : a.require && m.push(this.on("add", f).cancel)
                },
                unuse(a) {
                    r[a] && (r[a].forEach(m=>m()),
                        delete r[a]),
        ...
        o(Qn, "make");
        function je(e, n, r) {
            return T.objEvents[e] || (T.objEvents[e] = new it),
        ...
        function er() {
            U.onKeyPress("f1", ()=>{
                ...
                U.onKeyPress("f7", ()=>{
                        //se.timeScale = wt(Ne(se.timeScale - .2, 0, 2), 1)
                    }
                ),
                U.onKeyPress("f9", ()=>{
                        //se.timeScale = wt(Ne(se.timeScale + .2, 0, 2), 1)
        ...
        o(ps, "getGravity");
        function gs(...e) {
            e.length === 1 || e.length === 2 ? (w.bgColor = W(e[0]),
            e[1] && (w.bgAlpha = e[1])) : (e.length === 3 || e.length === 4) && (w.bgColor = W(e[0], e[1], e[2]),
            e[3] && (w.bgAlpha = e[3])),
                h.clearColor(w.bgColor.r / 255, w.bgColor.g / 255, w.bgColor.b / 255, w.bgAlpha)
        }
        o(gs, "setBackground");
        function ws() {
        ...
        function Cs(e={}) {
            ...
            return {
                ...
                update() {
                    this.isOffScreen() ? (r || (this.trigger("exitView"),
                        r = !0),
                    e.hide && (this.hidden = !0),
                    e.pause && (this.paused = !0),
                    e.destroy && this.destroy()) : (r && (this.trigger("enterView"),
                        r = !1),
        ...
        function Ts(e={}) {
            ...
            return {
                ...
                update() {
                    for (let i in n)
                        r.has(Number(i)) || (this.trigger("collideEnd", n[i].target),
                            delete n[i]);
                    r.clear()
                },
                drawInspect() {
                ...
                onClick(i) {
                    ...
                    return this.onDestroy(()=>u.cancel()),
                        u
                },
                onHover(i) {
                    let u = !1;
                    return this.onUpdate(()=>{
                            u ? u = this.isHovering() : this.isHovering() && (u = !0,
                                i())
                        }
                    )
                },
                ...
                resolveCollision(i) {
                    ...
                    u && !u.resolved && (this.pos = this.pos.add(u.displacement),
                        u.resolved = !0)
                },
                localArea() {
        ...
        function Un(e, n={}) {
            ...
            let l = o((a,m,f,p)=>{
                    let x = S(1, 1);
                    return f && p ? (x.x = f / (a.width * m.w),
                        x.y = p / (a.height * m.h)) : f ? (x.x = f / (a.width * m.w),
                        x.y = x.x) : p && (x.y = p / (a.height * m.h),
                        x.x = x.y),
                        x
                }
                , "calcTexScale");
            return {
                ...
                draw() {
                    ...
                    if (r.slice9) {
                        let {left: m, right: f, top: p, bottom: x} = r.slice9
                            ...
                            , H = x / q
                            , F = 1 - _ - H
                            , Ue = [ue(0, 0, O, _), ue(O, 0, te, _), ue(O + te, 0, A, _), ue(0, _, O, F), ue(O, _, te, F), ue(O + te, _, A, F), ue(0, _ + F, O, H), ue(O, _ + F, te, H), ue(O + te, _ + F, A, H), ue(0, 0, m, p), ue(m, 0, j, p), ue(m + j, 0, f, p), ue(0, p, m, $), ue(m, p, j, $), ue(m + j, p, f, $), ue(0, p + $, m, x), ue(m, p + $, j, x), ue(m + j, p + $, f, x)];
                        for (let y = 0; y < 9; y++) {
                            let R = Ue[y]
                                , P = Ue[y + 9];
                ...
                update() {
                    ...
                    i.timer >= 1 / i.speed && (i.timer = 0,
                        a.from > a.to ? (this.frame--,
                        this.frame < a.to && (i.loop ? this.frame = a.from : (this.frame++,
                            i.onEnd(),
                ...
                play(a, m={}) {
                    ...
                    let f = r.anims[a];
                    if (f === void 0)
                        console.error(`Anim not found: ${a}`);
                    i && this.stop(),
                        i = typeof f == "number" ? {
                            name: a,
                            timer: 0,
        ...
        function As(e, n={}) {
            function r(i) {
                ...
                return n.width || (i.width = u.width / (i.scale?.x || 1)),
            ...
            return {
                ...
                add() {
                    ...
                    this.onCollideUpdate((l,a)=>{
                            if (l.is("body") && !a.resolved && (this.trigger("beforePhysicsResolve", a),
                        ...
                        this.onPhysicsResolve(l=>{
                                T.gravity && (l.isBottom() && this.isFalling() ? (n.y = 0,
                                    r = l.target,
                                    i = l.target.pos,
                                    u ? u = !1 : this.trigger("ground", r)) : l.isTop() && this.isJumping() && (n.y = 0,
                ...
                update() {
                    ...
                    if (u && (r = null,
                        ...
                        if (!this.isOverlapping(r) || !r.exists() || !r.is("body"))
                            ...
                            !r.pos.eq(i) && e.stickToPlatform !== !1 && this.moveBy(r.pos.sub(i)),
                                i = r.pos;
                            return
                        }
                    let l = n.y;
        ...
        function Bs(e=2) {
            ...
            return {
                ...
                doubleJump(r) {
                    n <= 0 || (n < this.numJumps && this.trigger("doubleJump"),
                        n--,
                        this.jump(r))
                },
                onDoubleJump(r) {
        ...
        function js(e, n={}) {
            ...
            return {
                ...
                async add() {
                    await gt(e),
                    r > 0 && this.opacity && await Cn(this.opacity, 0, r, i=>this.opacity = i, ot.linear),
                        this.destroy()
                }
            }
        }
        ...
        function or(e={}) {
            ...
            return {
                ...
                set tilePos(m) {
                    let f = this.getLevel();
                    n = m.clone(),
                        this.pos = S(this.tilePos.x * f.tileWidth(), this.tilePos.y * f.tileHeight()).add(this.tilePosOffset)
                },
                get tilePos() {
                    return n
                },
            ...
            let r = bt([Nt(n.pos ?? S(0))])
                ...
                , $ = o(()=>{
                    ...
                    for (let R of r.children) {
                        ...
                        (R.tilePos.x != P.x || R.tilePos.y != P.y) && (y = !0,
                            j(R),
                            R.tilePos.x = P.x,
                            R.tilePos.y = P.y,
                            q(R))
                ...
                spawn(y, ...R) {
                    ...
                    Y || G.push(or());
                    let oe = r.add(G);
                    return N && (oe.tilePosOffset = oe.pos.clone()),
                        oe.tilePos = P,
                    l && (q(oe),
                ...
                getTilePath(y, R, P={}) {
                    ...
                    m || A(),
                    f || te(),
                    y.x < 0 || y.x >= u || y.y < 0 || y.y >= i || R.x < 0 || R.x >= u || R.y < 0 || R.y >= i)
                        return null;
                    let G = p(y)
                        , N = p(R);
                    if (a[N] === 1 / 0)
                    ...
                    for (me.set(G, 0); Y.length !== 0; ) {
                        ...
                        for (let Ke of An) {
                            ...
                            (!me.has(Ke) || On < me.get(Ke)) && (me.set(Ke, On),
                                Y.insert({
                                    cost: On,
                                    node: Ke
                                }),
            ...
            return {
                ...
                setTarget(l) {
                    n = l,
                        ...
                        i = r ? 0 : null,
                        r ? (u || (u = this.getLevel().onNavigationMapChanged(()=>{
                                r && i !== null && (r = this.getLevel().getPath(this.pos, n, {
                                    allowDiagonals: this.allowDiagonals
                                }),
                                    i = r ? 0 : null,
                                    r ? this.trigger("navigation-next", this, r[i]) : this.trigger("navigation-ended", this))
                            }
                        ),
                            this.onDestroy(()=>u.cancel())),
                            this.trigger("navigation-started", this),
                            this.trigger("navigation-next", this, r[i])) : this.trigger("navigation-ended", this)
                },
                update() {
                    if (r && i !== null) {
        ...
        function ni(e, n={}) {
            ...
            return l.wait(.4 / i, ()=>l.use(ur(i, u))),
        ...
        function si() {
            ...
            e.shake = Me(e.shake, 0, 5 * Te()),
                e.transform = new J().translate(_t()).scale(e.scale).rotate(e.angle).translate((e.pos ?? _t()).scale(-1).add(n)),
                T.root.draw(),
                fe()
        }
        o(si, "drawFrame");
...
`),
        ...
        U.run(()=>{
                Ft(),
                B.loaded || Fe() === 1 && !qt && (B.loaded = !0,
                    T.events.trigger("load")),
                    !B.loaded && s.loadingScreen !== !1 || qt ? ii() : (se.paused || cr(),
                        ri(),
                        si(),
                    s.debug !== !1 && oi()),
                qt && (qt = !1),
        ...
        o(hr, "updateViewport"),
            U.onResize(()=>{
                    ...
                    e && !s.stretch && !s.letterbox || (c.width = c.offsetWidth * I,
                        c.height = c.offsetHeight * I,
                        hr(),
                    e || (w.frameBuffer.free(),
        ...
        if (s.plugins && s.plugins.forEach(ir),
        s.global !== !1)
            for (let e in tt)
                window[e] = tt[e];
        return U.canvas().focus(),
            tt
    }
    , "default");
export {mo as default};
//# sourceMappingURL=kaplay.mjs.world
