export default (k) => {
    return {
         ...
         * @param {Array<string> | JSON | null} tilesets Pass an array of file paths pointing to the tilesets data or the tilesets data itself, pass nothing or null to use tilesets, built in to the world.
         * @returns {TiledImporter} A class that contains all world data provided as well as some functions for accessing that data and implementing it to the game.
         */
...
class TiledImporter {
    ...
    /**
     * Loads the world. Uses Promises to handle loading so use it with async/await or with callbacks.
     */
    async loadMap() {
    ...
    /**
     * Retrieves layers of the world as a simple array-object structure.
    ...
    /**
     * Retrieves the index of a layer on the world by its name.
     * @param {string} name Name of the layer.
     * @param {TiledImporter.layerTypes | null} type Type of the layer, optional.
     * @returns {number} Index of the layer in world. Will be used to referance it in other methods.
     */
     ...
     * @param {number} layerIndex Index of the layer in the world, use getLayerIndex to retrieve it from name.
    ...
    /**
     * Add all layers in the world into a kaboom game. All tile layers must use the same tileset and source image
